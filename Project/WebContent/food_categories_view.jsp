                ...
                <div id="tab-1" class="page-content tab active">
                    <div class="content-block">
                        ...
                        <%
											...
											String categoriesClick=categories;
											
											if(categories.equals("china"))
												categories="중식";
											else if(categories.equals("japan"))
												categories="일식";
											else if(categories.equals("korea"))
												categories="한식";
											else if(categories.equals("chicken"))
												categories="치킨";
											else if(categories.equals("bunsik"))
												categories="분식";
											else if(categories.equals("pizza"))
												categories="피자";
											...
											for(int i=0; i<dtos.size();i++){	
												...
												if(!dto.getCategory().equals(categories))
													continue;
