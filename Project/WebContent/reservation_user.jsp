						...
						<div class="list-block media-list margin-top-15">
							<ul>						
									...
									<div class="item-content">
										...
										<div class="item-inner no-margin">
										  <div class="item-input">
											id : <input type="text" class="text-thiny" value=<%=reservationDto.getUserId() %>>
										  </div>
										</div>
								...
								for(int j=0;j<cartDtos.size();j++){
									...
									if(!cartDto.getUserId().equals(id))
										continue;
								%>
							...
							<div class="text-center margin-bottom-15">
								<a href="reservation_delete.do?businessNumber=<%=reservationDto.getBusinessNumber() %>&userId=<%=reservationDto.getUserId() %>" class="button button-fill color-facebook text-thiny">예약 취소</a>
							</div>
								</li>
